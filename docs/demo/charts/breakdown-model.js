...
function rowOf(group, maxKnownMicros, totalKnownMicros) {
    ...
    const note = group.unpriced_requests > 0
...
function ariaLabelOf(what, range, groups) {
...
export function buildBreakdown(response, what) {
    ...
    return {
        ...
        visibleRows,
        hiddenCount,
        footnote: response.unrouted_requests > 0
