...
import { DEFAULT_RANGE, type RangeId, rangeFromHash, rangeOption, savedHeading } from './ranges.ts';
...
class Dashboard {
  ...
  private readonly defaultRange: RangeId;
  ...
  private openStream(): void {
    if (this.source.kind === 'snapshot') return;
...
export function startDashboard(source: DataSource): void {
